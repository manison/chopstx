...
#define GPIO_OTHER_BASE GPIOB_BASE /* push button */
...
/*
 * Port B setup
 * PB8  - push button (input with pull-up)
 */
#define VAL_GPIO_OTHER_ODR          0x00000100
#define VAL_GPIO_OTHER_CRL          0x44444444      /*  PB7...PB0 */
#define VAL_GPIO_OTHER_CRH          0x44444448      /* PB15...PB8 */
#define _VAL_GPIO_OTHER_ODR          0xFFFFFFFF
#define _VAL_GPIO_OTHER_CRL          0x88888888      /*  PB7...PB0 */
#define _VAL_GPIO_OTHER_CRH          0x88888888      /* PB15...PB8 */
